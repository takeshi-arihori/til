...
[EC2上にMySQLインストール時のエラー](https://github.com/takeshi-arihori/til/blob/main/published/cloud/aws/ec2/gpg_error.md)
...
## CDNの利用
### 手順
CloudFront用の証明書を作成 -> RDSでドメイン紐づけ

## リソース削除
RDS -> AutoScaling -> ロードバランサ -> ターゲットグループ -> AMI(EC2スナップショット) -> 起動テンプレート -> EC2 -> キーペア -> VPC -> CloudFront -> 証明書 -> Route53 
