...
## 3-3 コードでの契約
**契約プログラミング(契約による設計)**: 他のエンジニアにコードの使い方やどういう挙動が期待できるかどうかを伝える方法に関するいくつかの概念を形式化した原則

- **コードでの契約上の条件**
1. 事前条件: システムのあるべき状態や、コードに提供されるべき入力は何かといった、コードを呼び出す前に真であるべきこと。
2. 事後条件: システムの新しい状態や、返されるべき特定の値など、コードを呼び出した後に真であるべきこと。
3. 不変条件: コードの呼び出し前後で比較した際に代わるべきではないもの。

**重要**
コードを書くとき、その契約はどういったものか、どうしたら自分の作成したコードを使う人達が確実に契約を意識し、それに沿った行動をするかを考えることが重要。
